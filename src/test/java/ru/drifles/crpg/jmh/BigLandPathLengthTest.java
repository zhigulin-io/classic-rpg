...
public class BigLandPathLengthTest {
    ...
    private static final Position destination = new Position(255, 255);


    static {
        try {
            emptyLand = new Land("/level_big_1.world");
            fullLand = new Land("/level_big_2.world");
            semiLand = new Land("/level_big_3.world");
